...
/* NIA: Making the assumption that your asking for varA and varB be equal in value and type.
Could be asking for a non strict == but not sure.
*/
...
// Nia: Because I used the === operand it evaluates the contents of the variables by both type and value.
// This means that a string '3' will not be equal to the number 3.
// Also a string 'true' will not be equal to the boolean true.
...
//NIA: Assuming Fizz Buzz has priority here, ie numbers divisible by 15 being assigned 'Fizz Buzz'
//take precedent over the fact that its also divisible by 3 or 5.
...
//Exercise 6
console.log(exercise6(3,3,6));
console.log(exercise6(3,3,3));
console.log(exercise6(3,4,6));
...
console.log(exercise7(55));

//Exercise 8
console.log(exercise8(10, 8, 1, 11));
console.log(exercise8(10, 8, 9, 11));
console.log(exercise8(10, 8, 10, 11));

//Exercise 9
console.log(exercise9(true));
console.log(exercise9("test"));
console.log(exercise9(1));
console.log(exercise9(7));
console.log(exercise9(101));
console.log(exercise9(1000000));
console.log(exercise9(55));
...
// NIA: Not too bad but definitely harder than the last one, took me over an hour.
//I had forgotten about switch statements, I had to use MDN for that one. Also MDN for the typeof method.
